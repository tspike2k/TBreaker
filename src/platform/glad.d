...
/*
    ...
    OpenGL loader generated by glad 0.1.29 on Tue Mar 12 20:26:58 2019.
    ...
    Commandline:
        --profile="core" --api="gl=3.2" --generator="d" --spec="gl" --extensions=""
    Online:
        https://glad.dav1d.de/#profile=core&language=d&specification=gl&loader=on&api=gl%3D3.2
*/
...
private alias void* function(const(char)*) Loader;
...
bool gladLoadGL(Loader load) {
    ...
    version(testing) load_optional(load);
...
version(testing)
{
    void load_optional(Loader load) {
...
version(testing) fp_glDebugMessageCallback glDebugMessageCallback;
}
